...
This is built with Next.js, starting with a template from the App Router Course. For more information about working with Next.js, see the [course curriculum](https://nextjs.org/learn).
